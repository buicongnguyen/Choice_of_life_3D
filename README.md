...
This is a compact complete 3D edition, version 0.1.1. It contains six scene families, twenty GLB assets, 24 authored encounters, 72 options, 36 optional discoveries, three partner candidates, and a personalized ending. Story consequences use named facts and recurring dialogue. Characters use articulated mesh pivots with distance-driven walking and a seated baby scoot, rather than full armature animation clips.
